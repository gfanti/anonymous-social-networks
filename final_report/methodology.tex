...
Initially, we considered a number of heuristic estimators that achieved low detection rates due to a mismatch between the estimator design and the underlying spreading model. We eventually settled on two estimators, which we will discuss in this section.
