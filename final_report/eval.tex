...
\begin{figure}
\centering
\includegraphics[height = 2.4in]{figures/ba_graphs}
\caption{Placeholder. %Delays $\theta_{ij}$ are modeled as Gaussians $\mathcal N(2,0.5)$, and spreading was run for 8 time units.
}
\label{fig:ba_graphs}
%\vspace*{-0.4in}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[height = 2.4in]{figures/ba_hops}
\caption{Placeholder. %Delays $\theta_{ij}$ are modeled as Gaussians $\mathcal N(2,0.5)$, and spreading was run for 8 time units.
}
\label{fig:ba_hops}
%\vspace*{-0.4in}
